...
BEGIN TRANSACTION [CHANGE_PERSON_ADDRESS]
	BEGIN TRY
...
BEGIN TRANSACTION [INSERT_NEW_CITIES]
	BEGIN TRY
		INSERT INTO [CITIES]
			([CITY_NAME],[AREA_NAME],[POSTAL_CODE], [UPDATE_COUNTER])
			VALUES
...
COMMIT TRANSACTION
	END TRY
	BEGIN CATCH
ROLLBACK TRANSACTION [INSERT_NEW_CITIES]
	END CATCH

BEGIN TRANSACTION [INSERT_PHONE_NUMBER]
	BEGIN TRY
...
COMMIT TRANSACTION
	END TRY
	BEGIN CATCH
ROLLBACK TRANSACTION [INSERT_PHONE_NUMBER]
	END CATCH