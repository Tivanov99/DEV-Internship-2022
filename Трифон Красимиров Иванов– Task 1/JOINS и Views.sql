...
DROP VIEW IF EXISTS [VI_PERSON_DATA]

CREATE VIEW [VI_PERSON_DATA] AS
SELECT [FIRST_NAME],
		[SECOND_NAME],
		[LAST_NAME] ,
...
DROP VIEW IF EXISTS [VI_COUNT_PERSONS_FROM_BURGAS]

CREATE VIEW [VI_COUNT_OF_PERSONS_FROM_BURGAS] AS
...
SELECT * FROM [PERSONS]
FULL OUTER JOIN [CITIES] ON [PERSONS].[CITY_ID] = [CITIES].[ID] 
