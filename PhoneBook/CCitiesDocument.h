...
public:
	/// <summary>
	/// Функция която изчита всички записи на градовете от базата и ги записа в 'm_oCitiesArray'.
	/// </summary>
	/// <returns></returns>
	const CCitiesArray& GetAllCities();

	/// <summary>
	/// Функция която прочива и връща запис от базата на град според неговата стойност в колоната 'ID'.
	/// </summary>
	...
	/// <summary>
	/// Функция която изтрива запис от базата на град според неговата стойност в колоната 'ID'.
	/// </summary>
	/// <param name="lID"></param>
	/// <returns></returns>
	...
	/// <summary>
	/// Функция която изпраща получения като аргумент запис към базата и там се налагат промените от него към записа от базата.
	/// </summary>
	...
	/// <summary>
	/// Функция която добавя нов запис към базата.
	/// </summary>
	/// <param name="recCity"></param>
	/// <returns></returns>
...
private:
	/// <summary>
	/// Функция при която при някаква промяна на записите се извиква и актуализира view-то.
	/// </summary>
	...
	/// <summary>
	/// Функция която изтрива запис според ноговото 'ID' от масива който се изолзва като хранилище 'm_oCitiesArray'.
	/// </summary>
	...
	/// <summary>
	/// Функция която добавя запис към масива който се изолзва като хранилище 'm_oCitiesArray'.
	/// </summary>
	...
	/// <summary>
	/// Връща позицията на която се намира даден запис с уникален идентификатор 'ID' в хранилището 'm_oCitiesArray'.
	/// </summary>
...
private:
	/// <summary>
	/// Масив който съдържа всички записи от базата. Използва като хранилище.
	/// </summary>
	CCitiesArray m_oCitiesArray;

	/// <summary>
	/// Мембър чрез който се достъпва функционалността на табличния клас 'CCitiesData'.
	/// </summary>
