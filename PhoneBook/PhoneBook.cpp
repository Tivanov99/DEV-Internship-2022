...
BOOL CPhoneBookApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_PhoneTypes,
	...
	pCitiesDcTemplate = new CMultiDocTemplate(IDR_Cities,
	...
	pPersonsDcTemplate = new CMultiDocTemplate(IDR_Persons,
