...
private:
	...
	CITIES& m_recCity;
	/// <summary>Мембър отговарящ за входното поле съдържащо името на градът.</summary>
	CEdit m_edbCityName;
	/// <summary>ембър отговарящ за входното поле съдържащо името на областта.</summary>
	CEdit m_edbCityAreaName;
	/// <summary>Мембър отговарящ за входното поле съдържащо пощенски код.</summary>
	...
	/// <summary>Мембър съдържащ методи за валидиране на сойностите в текстовите полета.</summary>
	CCitiesDataValidator m_oDataValidator;
private:
	/// <summary>Функция изпълняваща се когато в диалоговия прозорец се избере бутона 'Ok'</summary>
	CButton btn_Ok;
};
